Profile: AUCoreBodyTemperature
Parent: $bodytemp
Id: au-core-bodytemp
Title: "AU Core Body Temperature"
...
* . ^definition = "Measurement of a patient's body temperature at a point in time."
* . ^comment = "Body temperature observation using a LOINC code, a SNOMED CT code and a metric UCUM unit of measure."
* status = #final (exactly)
* code.coding contains snomedBodyTempCode 1..1
* code.coding[snomedBodyTempCode] ^short = "SNOMED CT Body Temperature"
* code.coding[snomedBodyTempCode].system 1..
* code.coding[snomedBodyTempCode].system = "http://snomed.info/sct" (exactly)
* code.coding[snomedBodyTempCode].code 1..
* code.coding[snomedBodyTempCode].code = #386725007 (exactly)
...
* performer MS
* valueQuantity ^short = "Body temperature"
* valueQuantity ^condition = "au-core-obs-02"
* valueQuantity.code from $metric-body-temperature-units-1 (required)
* dataAbsentReason MS
