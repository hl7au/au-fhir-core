...
This profile applies a `patternCodeableConcept` on `Observation.code` requiring the SNOMED CT code 1747861000168109, and an optional slice on `Observation.code.coding` for the LOINC smoking status code. 
