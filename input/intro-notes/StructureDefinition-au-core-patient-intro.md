...
<p class="stu-note">Specific feedback is sought on proposal to implement support for Gender Harmony Name to Use (NtU) concept in AU Core by making name.use a Must Support element in AU Core Patient.<br/>Please comment on <a href="https://github.com/hl7au/au-fhir-core/issues/86">au-fhir-core/issues/86</a>.</p>
