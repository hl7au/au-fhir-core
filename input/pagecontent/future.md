...
AU Core will be published yearly. Yearly AU Core updates reflect changes to:
 ...
 <div> 
    <img src="yearlyupdate.png" alt="Yearly update of AU Core" style="width:80%"/>
  </div>
...
The first release of AU Core was an [18 month process](https://hl7.org.au/fhir/core/1.0.0/future.html#au-core-r1-development-process) from HL7 AU proposal to publication, this subsequent release follows an ongoing maintenance release process, outlined in the figure below:


 <div> 
    <img src="R2Process.png" alt="AU Core R2 Development Process" style="width:90%"/>
  </div>
...
* **Additional Medicinal Information**: Additional AU Core profiles to support common implementation of additional aspects of medicinal information and workflow including administration are expected to be developed and tested in future versions of AU Core.
...
* **No Known X**: Additional work to clarify how a system can represent an affirmative state that a patient has no history of immunisation, no history of relevant procedures, or other relevant concepts of "no known x" or "no history of x" is expected to be undertaken in future releases. 
