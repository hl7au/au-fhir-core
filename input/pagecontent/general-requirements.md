...
A system **SHOULD** support all AU Core profiles unless the system does not anticipate supplying or consuming a certain type of data, usually by virtue of playing a limited or specialised role in clinical or information workflows. For example, a pathology laboratory may support [AU Core DiagnosticReport](StructureDefinition-dh-diagnosticreport-core-1.html), but not [AU Core MedicationRequest](StructureDefinition-dh-medicationrequest-core-1.html).
